...
## 7. Clean Cutover and Verification
 ...
 - [ ] 7.5 Build and install the debug application through the repository devshell, then verify on the physical Android device that add, configure, select, reorder, remove, restart persistence, RSM/phone PTT, hardware traversal, and Android Auto ordering preserve existing audio behavior
