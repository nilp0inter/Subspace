...
The system SHALL handle encoding failures gracefully. If MediaCodec fails to encode a capture, the system SHALL log the error and not crash.

#### Scenario: MediaCodec encoding fails
